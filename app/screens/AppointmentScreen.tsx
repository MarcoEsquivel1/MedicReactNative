        ...
        <FlatList<Appointment>
          ...
          renderItem={({ item, index }) => (
            <View style={{ flex: 1, width: "100%", marginBottom: 15 }}>
              <AppointmentCard appointment={item} index={index} onDelete={handleDelete} selectedAppointment={selectedAppointment} setSelectedAppointment={setSelectedAppointment} />
            </View>
          )}
        />
      </View>
